      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[320px] space-y-6">
          <div className="space-y-2 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">Join HaloRide for a safer journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="firstName" placeholder="John" required className="h-12 text-base" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="lastName" className="text-base block">
                  Last name
                </Label>
                <Input id="lastName" placeholder="Doe" required className="h-12 text-base" />
              </div>
            </div>
